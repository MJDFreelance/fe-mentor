...
export const TaskAdd = ({selection, setSelection, columns, onSaved}:any) => {
    const {handleSubmit, register, control, formState} = useForm({defaultValues: {...selection?.item, userId: `1`}});
            ...
            <DialogContent className={`w-full`}>
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className={`flex flex-col gap-2`}>
                        ...
                        <button type={`button`} onClick={() => subtaskArray.append({title: ``, isCompleted: false})}>Add
                            Subtask
                        </button>
                    </div>
