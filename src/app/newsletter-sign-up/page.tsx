...
const Page = () => {
  return (
    <>
      <article
        className={`flex flex-col w-max md:flex-row-reverse bg-white max-md:min-h-screen text-[#242742] 
                    text-[16px] leading-[1.5] md:p-6 md:rounded-[36px] md:gap-16 hidden`}
      >
        <picture>
          <source
            srcSet="/newsletter-sign-up/illustration-sign-up-desktop.svg"
        ...
        <section className={`grid gap-6 w-full py-10 px-6 md:ml-10`}>
          ...
          <ul className={`flex flex-col gap-2.5 mb-4`}>
            <li className={`flex items-start`}>
              <img
                src={`/newsletter-sign-up/icon-list.svg`}
                className={`mr-3`}
              />
      ...
      <article
        className={`flex flex-col bg-white max-md:min-h-screen text-[#242742] text-[16px] leading-[1.5] 
                    px-6 py-5 md:p-16 md:h-max md:w-max rounded-[36px]`}
      >
        <div className={`flex-1 flex flex-col justify-center gap-6`}>
          <img
            src={`/newsletter-sign-up/icon-list.svg`}
            className={`mr-3 h-16 w-16 mb-4`}
          />
          <h2 className={`font-bold text-[40px] md:max-w-[10ch] leading-[1]`}>
        ...
        <button
          className={`mt-4 text-white bg-[#242742] py-4.5 rounded-[8px] md:mt-10
